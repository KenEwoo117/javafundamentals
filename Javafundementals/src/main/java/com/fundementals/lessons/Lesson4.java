...
public class Lesson4 {
   ...
   * by a numeric index value starting at 0.*/
   ...
   /* concat joins tw strings together as concatenation.
   * Same as the joinWelcome method above. */
    ...
    /* toLower & toUpper will change all
     *characters to the specified case*/
    ...
    * empty spaces*/
    ...
    /*String builder allow you to join objects or primitives
    together in a variable array or list.*/
    public String favoriteThings(String color, String food) {
        ...
        builder2.append("My favorite color is ");
